...
export default {
  ...
  leavingGame(gameRoomId, playerID, failedToReconnect) {
    // bbbbb testing
    // return;
    console.log("leaving room 3!!");
    Meteor.call('leavingGame', gameRoomId, playerID, failedToReconnect, (err) => {
      if (err) {
  ...
  reportGameResult(gameRoomId, winnerPlayerUserId, player0Gold, player1Gold) {
