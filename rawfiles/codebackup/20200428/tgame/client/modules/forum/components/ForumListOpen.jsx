...
class ForumListOpenComponents extends React.Component {
  render() {
    return (
      <div className="tg-page tg-page--BG">
        <Banner title="Blog" />
        <div className="tg-page__content tg-container tg-page__content--BG">
          <div className="tg-title-topic">
            <div className="tg-title-topic__line">
              <span className="tg-title-topic__line__title">Topic Title</span>
              <span className="categories-name"> Code help
                <i className="type-categories type-categories--a" />
              </span>
            </div>
            <div className="tg-title-topic__line">
              <span className="tg-title-topic__line__link">Back to Forum</span>
            </div>
          </div>
...
export default ForumListOpenComponents;
