...
export default class DatePicker extends React.Component {
  ...
  componentDidMount() {
    if (this.props.initialDate) {
        ...
        this.changeDate({ target: { value: date.date() } }, 'selectDay');
        this.changeDate({ target: { value: date.month() + 1 } }, 'selectMonth');
        this.changeDate({ target: { value: date.year() } }, 'selectYear');
    }
  }
