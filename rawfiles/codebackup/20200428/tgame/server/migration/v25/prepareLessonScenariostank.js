...
lessonObj.baselineCode = `
function getNewCommand() { 
  // fill in the column and row numbers of the turning points. 
...
lessonObj = {
  ...
  ScenarioName: `[${lessonNumber}] Grabbing Special Weapons`,
...
lessonObj = {
  ...
  coins: 1000,
  concepts: 'If condition and rule based system re-visit',
  ScenarioName: `[${lessonNumber}] Attacking Opponent Tanks`,
...
lessonObj = {
  ...
  coins: 800,
  concepts: '2D array and nested loop',
  ScenarioName: `[${lessonNumber}] Two-Dimentional Array`,
  lessonName: '2DArrayTutorial',
  ScenarioSequenceNumber: lessonNumber,
  SetupScript: `
ClearMaze();
RemoveAllTanks();
...
lessonObj = {
  ...
  ScenarioName: `[${lessonNumber}] Avoid Dangerous Areas`,
...
sendCommandToWhiteTank(6, "L");
sendCommandToWhiteTank(10, "L");
...
PlaceTank('blue', 7, 4);
SetTankProperties(0, { health: 1400 });
...
SetTankProperties(6, {specialPower: { damage: 1}});
SetTankProperties(7, {specialPower: { damage: 1}});
SetTankProperties(8, {specialPower: { damage: 1}});
SetTankProperties(9, {specialPower: { damage: 1}});
SetTankProperties(10, {specialPower: { damage: 1}});

await SetupTickUpdates(80);
...
lessonObj = {
  ...
  ScenarioName: `[${lessonNumber}] The Freezer`,
  lessonName: 'StrategiesForFreezer',
  ScenarioSequenceNumber: lessonNumber,
  SetupScript: `
ClearMaze();
RemoveAllTanks();
...
PlaceTank('white', 10, 7, false); 
PlaceTank('white', 3, 6, false); 
PlaceWeapon(SPECIAL_WEAPON_TYPES.FREEZER, 6, 6); 
...
`,
  ...
  hideReleaseButton: false,
  applyBaselineCode: false,
  group: TUTORIAL_GROUP.INTERMEDIATE.SPECIAL_WEAPONS
};
...
lessonObj = {
  ...
  package: 'intermediate',
  coins: 1200,
  concepts: 'Special strategies',
  ScenarioName: `[${lessonNumber}] The Missile`,
  lessonName: 'StrategiesForMissile',
  ScenarioSequenceNumber: lessonNumber,
  SetupScript: `
ClearMaze();
RemoveAllTanks();
...
PlaceTank('white', 10, 7, false); 
PlaceTank('white', 3, 6, false); 
PlaceWeapon(SPECIAL_WEAPON_TYPES.MISSILE, 6, 3); 
PlaceTank('red', 13, 12);
...
lessonObj = {
  ...
  coins: 1200,
  concepts: 'Special strategies',
  ScenarioName: `[${lessonNumber}] The 3-Splitter`,
  lessonName: 'StrategiesFor3Splitter',
  ScenarioSequenceNumber: lessonNumber,
  SetupScript: `
ClearMaze();
RemoveAllTanks();
...
PlaceTank('blue', 6, 8); 
PlaceTank('white', 1, 12, false); 
PlaceWeapon(SPECIAL_WEAPON_TYPES.SPLITTER3, 6, 9); 
...
lessonObj = {
  ...
  coins: 1200,
  concepts: 'Special strategies',
  ScenarioName: `[${lessonNumber}] The Nova`,
  lessonName: 'StrategiesForNova',
  ScenarioSequenceNumber: lessonNumber,
  SetupScript: `
ClearMaze();
RemoveAllTanks();
...
PlaceTank('blue', 6, 8); 
PlaceTank('white', 1, 12, false); 
PlaceTank('white', 6, 4, false); 
PlaceTank('white', 6, 2, false); 
...
lessonObj = {
  ...
  coins: 1200,
  concepts: 'Special strategies',
  ScenarioName: `[${lessonNumber}] The 4-Way`,
  lessonName: 'StrategiesFor4Way',
  ScenarioSequenceNumber: lessonNumber,
  SetupScript: `
ClearMaze();
RemoveAllTanks();
...
PlaceTank('blue', 6, 8); 
PlaceTank('white', 1, 12, false); 
PlaceTank('white', 12, 7, false); 
PlaceTank('white', 12, 11, false); 
PlaceWeapon(SPECIAL_WEAPON_TYPES.WAY4, 6, 9); 
...
lessonObj = {
  ...
  package: 'intermediate',
  coins: 1000,
  concepts: 'Impacts of opponent actions',
  ScenarioName: `[${lessonNumber}] Competing For Resources Against Opponents`,
  lessonName: 'ConsiderOpponentsPosition',
  ScenarioSequenceNumber: lessonNumber,
  SetupScript: `
ClearMaze();
RemoveAllTanks();
...
`,
  ...
  hideReleaseButton: false,
  applyBaselineCode: false,
  group: TUTORIAL_GROUP.INTERMEDIATE.OPPONENT_IMPACTS
};
...
lessonObj = {
  ...
  package: 'intermediate',
  coins: 1000,
  concepts: 'Impacts from opponents',
  ScenarioName: `[${lessonNumber}] Consider Opponent's Weapon and Special Power`,
  lessonName: 'ConsiderOpponentsStrength',
  ScenarioSequenceNumber: lessonNumber,
  SetupScript: `
ClearMaze();
RemoveAllTanks();
...
PlaceTank('blue', 6, 7);
PlaceTank('red', 4, 5, false);
PlaceTank('red', 11, 8, false);
PlaceCrystal(7, 5);

SetTankProperties(0, {specialPower: {
  speed: 2, damage: 0, reload: 0, healthRegen: 0}});

SetTankProperties(1, {specialPower: {
  speed: 3, damage: 2, reload: 2, healthRegen: 2}});
SetTankProperties(3, {specialPower: {
  speed: 2, damage: 2, reload: 2, healthRegen: 2}});

SetTankProperties(1, {specialWeapon: 
  {type: SPECIAL_WEAPON_TYPES.SPLITTER3} });
SetTankProperties(3, {specialWeapon: 
  {type: SPECIAL_WEAPON_TYPES.FREEZER} });
...
lessonObj = {
  ...
  coins: 1000,
  concepts: 'Special strategies',
  ScenarioName: `[${lessonNumber}] End-Game Strategies`,
  lessonName: 'WhenTimesUp',
  ScenarioSequenceNumber: lessonNumber,
  SetupScript: `
ClearMaze();
RemoveAllTanks();
...
PlaceTank('white', 7, 1, false);
PlaceTank('white', 19, 3, false);
PlaceTank('white', 10, 1, false);
...
`,
  ...
  hideReleaseButton: false,
  applyBaselineCode: false,
  group: TUTORIAL_GROUP.INTERMEDIATE.TIME_IS_UP
};
...
const prepareLessonScenariosTank = () => {
  ...
  _.map(gameLessonScenarioData, (doc) => {
    ...
    doc._id = `T${id++}`;
    // console.log(`inserting new chat lesson ${doc._id} ${doc.ScenarioSequenceNumber}`);
