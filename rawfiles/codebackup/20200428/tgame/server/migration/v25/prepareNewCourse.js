...
var lessonObj = {
  userId: 'system',
  package: 'intermediate',
  LessonName: '[13] Accelerate Your Game Bot',
  LessonSequenceNumber: lessonNumber,
  coins: 1200,
...
var lessonObj = {
  userId: 'system',
  package: 'intermediate',
  LessonName: '[14] Accelerate Your Game Bot Using Angles',
  LessonSequenceNumber: lessonNumber,
  coins: 1200,
...
var lessonObj = {
  ...
  slideFileId: sid,
  _id: `L${lessonNumber}`,
  group: TUTORIAL_GROUP.INTERMEDIATE.INDIRECT_SHOTS
};
gameLessonScenarioData.push(lessonObj);
...
var lessonObj = {
  ...
  slideFileId: sid,
  _id: `L${lessonNumber}`,
  group: TUTORIAL_GROUP.INTERMEDIATE.ADVANCED_TECH
};
gameLessonScenarioData.push(lessonObj);
...
var lessonObj = {
  userId: 'system',
  package: 'starter',
  LessonName: '[3] Getting More Information',
  LessonSequenceNumber: lessonNumber,
  coins: 500,
...
var lessonObj = {
  ...
  LessonSequenceNumber: lessonNumber,
  coins: 800,
  concepts: 'Ternary Operator, Greedy Algorithm, Manhattan Distance',
  studyTime: "30 to 45 minutes",
  Difficulty: 3,
  gameId: tankGameId,
  gameName: 'SmartTank',
