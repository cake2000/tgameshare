...
const gameGeneralData = [
  ...
  // },
  // {
  //   _id: balloonBusterGameId,
  //   title: 'Balloon Buster',
  //   trackName: 'BalloonBuster',
  //   name: 'balloonbuster',
  //   imageUrl: '/images/balloonbusterlogo.png',
  //   description: `Scratch Basics III - Balloon Buster Game`,
  //   teamSize: 1,
  //   teamNumber: 2,
  //   multiplayerMode: [MULTIPLAYER_MODE.MODE1VS1],
  //   level: [
  ...
  //   seq: 3,
  //   name: 'levelb',
  //   imageUrl: '/images/B-150.png',
  //   description: `Second level for schools`,
  //   teamSize: 1,
  //   teamNumber: 2,
  //   multiplayerMode: [MULTIPLAYER_MODE.MODE1VS1],
  //   level: [
