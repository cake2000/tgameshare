 ...
 * 
 * @version
 * 4.0.1 (Fri, 08 Sep 2017 13:08:08 GMT)
 * 
 * @copyright
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(0, _domready2.default)(function () {
		window.syntaxhighlighter = _core2.default; // aaaa added by me to fix refresh issue
...
/***/ (function(module, exports) {
	...
	Renderer.prototype = {
	  ...
	  wrapLinesWithCode: function wrapLinesWithCode(str, css) {
        ...
        if (line.indexOf("//[h") >= 0) {
          const p = line.indexOf("//[h") + 4;
          let line1 = line.substring(p);
          const p2 = line1.indexOf("]");
          const hid = "h" + line1.substring(0, p2);
          const reg = new RegExp(`\/\/\\\[${hid}\\\]`);
          // line = line.replace(/\/\/[h0]/, "//[<a href='abc'>h0</a>]");
          //line = line.replace(/\/\/\[h0\]/, `//[<a href="#" onclick="ClickToSendChat(event, '${hid}')" class="inlinebutton">${hid}</a>]`); 
          line = line.replace(reg, `//[<a href="#" onclick="ClickToSendChat(event, '${hid}')" class="inlinebutton">${hid}</a>]`); 
