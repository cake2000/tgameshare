 ...
 */
const checkFocus = (selector, falseCase, done) => {
    /**
    ...
    if (falseCase) {
        expect(hasFocus)
            .toNotEqual(true, 'Expected element to not be focused, but it is');
    } else {
        expect(hasFocus)
            .toEqual(true, 'Expected element to be focused, but it is not');
    }
